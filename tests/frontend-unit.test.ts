...
test("workbench command bar exposes icon display controls and workflow groups", () => {
  ...
  ok(app.includes("Click Restore all or a toolbar name to show it again."));
  ok(app.includes("Restore all hidden toolbars"));
  ok(app.includes("Restore all"));
  ok(app.includes("Show ${row.label} toolbar"));
  ok(app.includes("Show ${row.label} Toolbar"));
  ok(app.includes("use the hidden toolbars tray or View menu to show it again"));
