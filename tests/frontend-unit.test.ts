...
test("workbench command bar exposes icon display controls and workflow groups", () => {
  ...
  ok(app.includes("Use Show all, Show toolbars, or View menu > Toolbars to restore hidden rows."));
  ...
  ok(app.includes("Show ${row.label} Toolbar"));
  ok(app.includes("use Show toolbars, the hidden toolbars tray, or View menu to show it again"));
