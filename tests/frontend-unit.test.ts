...
test("workbench command bar exposes icon display controls and workflow groups", () => {
  ...
  ok(app.includes("Use Show all, the Toolbars hidden menu, the floating restore button, or View > Toolbars to restore rows."));
  ok(app.includes("Show all hidden toolbar rows"));
  ok(app.includes("Click to show all rows"));
