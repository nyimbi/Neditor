...
| `openapi`, `json-schema` | API operations, security requirements, request/response contracts, response headers/links/examples, component schemas, nested fields, composition, object keywords, and schema constraints. |
