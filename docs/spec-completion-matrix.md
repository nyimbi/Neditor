...
| 22 Security/privacy | Local-first, trust-gated executable transforms, no shell | Partial | `docs/security-threat-model.md`; external transform runner/tests; local file design; archived browser workflow run `26157446711` covers transform trust prompts, path-change trust clearing, denied trust reset, and missing executable diagnostics | Independent security review and cross-platform process proof. |
