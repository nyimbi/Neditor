...
- Accessibility has an initial static guard, but full keyboard/manual audit
  ...
  loop, and repeated edit/cache stress coverage, but memory growth, UI debounce
  timing, progress reporting, cancellation behavior, and native/browser
