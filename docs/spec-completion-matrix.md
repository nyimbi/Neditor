...
| 26 Data storage | Preferences, recents, brand profiles, transform paths, snapshots, sidecars | Partial | Store plugin usage; schema-versioned workspace persistence migration; frontend unit migration/schema test; snapshot/export manifest modules | Storage docs and sidecar behavior proof. |
