...
| 13 Tables/data | Table editing, formulas, data sources | Partial | Table lib/UI/backend tests; `named_table_formulas_survive_cross_target_exports` proves named table/range formulas survive the export artifact family | Interaction tests and more data-source validation. |
