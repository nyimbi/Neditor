...
| 9.6 Includes | Include graph, diagnostics, re-render, export single doc | Partial | Document structure tests; compiler support; export manifests carry `include_graph`; Markdown bundles include `include-graph.json` plus include file maps | UI include graph/navigation and watcher workflow proof. |
