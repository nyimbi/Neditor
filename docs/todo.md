What remains to achieve the full vision:
  ...
  2. Canonical document AST
     ...
     scanners now preserve fenced-code examples, and layout shortcode tokens now pass through interpolation without false missing-variable warnings, so semantic layout directives do
     not make readiness reports noisy.
