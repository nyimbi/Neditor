What remains to achieve the full vision:
  ...
  7. Backend modularization
     ...
     builder helpers. The transform/external-transform, semantic export renderer, export command/readiness, and AI cleanup test clusters now live in dedicated nested test
     modules instead of the root backend fixture file. Still needed: split the remaining large compiler, table, media, and Git fixture clusters further as the feature set grows.
