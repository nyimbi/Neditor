What remains to achieve the full vision:
  ...
  1. Real semantic exporters
     ...
     figure boxes, figure float semantics affect DOCX/PPTX/PDF positioning, and fit="cover" maps to preview/export metadata plus DOCX/PPTX crop
     rectangles. Still needed: deeper page-aware behavior and richer crop-position controls.
