What remains to achieve the full vision:
  ...
  7. Backend modularization
     ...
     builder helpers. The transform/external-transform, semantic export renderer, export command/readiness, AI cleanup, and table/formula export test clusters now live in
     dedicated nested test modules instead of the root backend fixture file. Still needed: split the remaining large compiler, media, and Git fixture clusters further as the feature set grows.
