What remains to achieve the full vision:
  ...
  1. Real semantic exporters
     ...
     hyperlinks for cross references, DOCX citation links to bookmarked bibliography entries, and PDF/PPTX section header/footer overrides from layout directives. Still
     needed: true Word citation fields, DOCX section-specific header/footer parts, deeper page-aware behavior, richer PPTX layouts, and stronger media/layout fidelity.
