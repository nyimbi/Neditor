What remains to achieve the full vision:
  ...
  1. Real semantic exporters
     ...
     PPTX title, section-divider, two-column, and table-oriented slide layouts. SVG/PNG/JPEG dimensions now drive DOCX/PPTX image boxes, and SVG dimensions
     are recorded in bundle media metadata. Still needed: deeper page-aware behavior and richer media positioning/cropping fidelity.
