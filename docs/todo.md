What remains to achieve the full vision:
  ...
  7. Backend modularization
     ...
     and file/Git command test clusters now live in dedicated nested test modules instead of the root backend fixture file. Still needed: split the remaining large compiler fixture cluster further as the feature set grows.
