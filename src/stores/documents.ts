...
export const useDocumentsStore = defineStore("documents", {
  state: () => ({
    ...
    releaseTag: "",
    commitMessage: "",
    webhookConfigs: [] as Array<{ id: string; name: string; url: string; events: string[]; enabled: boolean }>,
    auditEnabled: true,
    auditAuthor: "",
    auditMaxBytes: 5000000,
    searchMaxResults: 200,
    searchDefaultCaseSensitive: false,
    humanizerDefaultMode: "standard" as "light" | "standard" | "heavy",
    compareMaxLines: 5000,
    compareIgnoreWhitespace: false,
    pandocBinaryPath: "",
    curlBinaryPath: "",
    restFetchAllowedHosts: [] as string[],
    restFetchTimeoutMs: 15000,
