...
const runbooks = [
  ...
  },
  {
    ...
    commands: [
      ...
      "Fill templates/google-docs/import-evidence.template.json.",
      "NEDITOR_GOOGLE_DOCS_IMPORT_EVIDENCE=/path/to/import-evidence.json pnpm run check:google-docs-import",
    ],
