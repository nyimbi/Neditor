...
const runbooks = [
  ...
  },
  {
    ...
    commands: [
      ...
      "Fill templates/ai-runtime/runtime-evidence.template.json without recording audio or clipboard content.",
      "NEDITOR_AI_RUNTIME_EVIDENCE=/path/to/runtime-evidence.json pnpm run check:ai-runtime",
    ],
  ...
  },
  {
    ...
    commands: [
      ...
      "Fill templates/security/security-review.template.json with independent reviewer metadata, covered trust boundaries, findings, report hashes, and release signoff.",
      "NEDITOR_SECURITY_REVIEW_EVIDENCE=/path/to/security-review.json pnpm run check:security-review",
    ],
  ...
  },
  {
    ...
    commands: [
      ...
      "Fill templates/performance/native-profile.template.json with profiler summary hashes, release binary hash, scenario metrics, soak results, and reviewer metadata.",
