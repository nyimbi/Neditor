...
const quickCommands = [
  ...
  command("Sidecar preparation script syntax", "node", ["--check", "scripts/prepare-ned-sidecar.mjs"]),
  ...
  command("Homebrew cask materializer syntax", "node", ["--check", "scripts/create-homebrew-cask.mjs"]),
