...
fn help_text() -> String {
    vec![
        ...
        "Outlines: proposal, rfp-response, rfp-technical-proposal, rfp-compliance-review, grant-application, standard-operating-procedure, product-requirements-document, project-charter, and more.".to_string(),
        format!(
