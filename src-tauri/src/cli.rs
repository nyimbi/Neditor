...
fn help_text() -> String {
    vec![
        ...
        "".to_string(),
        "URL scheme (macOS / Windows / Linux):".to_string(),
        "  neditor://open?path=/abs/path.md".to_string(),
        "  neditor://open?path=/abs/path.md&line=42&col=7".to_string(),
        "  neditor://export?path=/abs/path.md&format=html".to_string(),
        "".to_string(),
